...
weaver \
    ...
    --num-workers 1 --train-val-split 0.8889 \
    --batch-size 10 --num-epochs 5 --gpus '' --data-fraction 0.01 \
    --start-lr $lr --optimizer adam --log logs/QuarkGluon_${model}_{auto}${suffix}.log --predict-output pred.root \
